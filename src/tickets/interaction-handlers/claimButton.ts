...
export class ClaimButtonHandler extends InteractionHandler {
    ...
    /**
     * Handle what happens when the claim button is pressed.
    ...
    public async run(interaction: ButtonInteraction): Promise<void> {
        ...
        if (interaction.user.id === ownerUserId && !isAdministrator) {
            await interaction.editReply("You cannot claim your own ticket.");
            return;
        }
